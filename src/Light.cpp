...
bool Light::compareIntersects(Intersect vec1, Intersect vec2)
{
...
Intersect Light::getLineIntersect(sf::VertexArray ray, sf::VertexArray segment)
{
...
std::vector<Intersect> Light::getIntersectPoints( std::vector<sf::Vector2f> &shapeVectors, const std::vector<float> &uniqueAngles)
{
...
void Light::generateLight(std::vector<sf::Vector2f> &shapePoints, std::vector<float> &uniqueAngles)
{
...
void Light::render(sf::RenderTarget &target, sf::RenderStates &renderState)
{
